...
@Entity(tableName = "part", indices = {@Index(value = {"rfid"}, unique = true)})
public class PartEntry {
     ...
     */
    @Ignore
    public PartEntry(int weatherIconId, Date date, double min, double max, double humidity, double pressure, double wind, double degrees) {
     ...
     * @param degrees
     */
    public PartEntry(int id, int weatherIconId, Date date, double min, double max, double humidity, double pressure, double wind, double degrees) {
        this.id = id;
        this.weatherIconId = weatherIconId;
        this.date = date;
        this.min = min;
